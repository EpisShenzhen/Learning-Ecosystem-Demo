...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract("0x80f0115ff72cc76a104f1a293f3a2b841c79174D", "edition-drop").contract;

  // トークンコントラクトの初期化
  const token = useContract("0xB23b94e0088AD92a61E3c14C5bDa4B175e91Ad36", "token").contract;

  // 投票コントラクトの初期化
  const vote = useContract("0xbcBC75BB0890D17F274c75C6C28A89Ae8869DB43", "vote").contract;
      ...
      <div className={styles.container}>
        <main className={styles.main}>
          <h1 className={styles.title}>
            Welcome to Learning Ecosystem Dao !!
          </h1>
